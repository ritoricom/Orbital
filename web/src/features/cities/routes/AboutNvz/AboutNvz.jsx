...
import promoImg from "@/assets/images/nvz/alternative-promo.jpg";
import cafeImg1 from "@/assets/images/nvz/cafe-1.jpg";
import cafeImg2 from "@/assets/images/nvz/cafe-2.jpg";
import cafeImg3 from "@/assets/images/nvz/cafe-3.jpg";
import cafeImg4 from "@/assets/images/nvz/cafe-4.jpg";

export const AboutNvz = ({ reviews, rooms, contacts }) => {
  const { t } = useTranslation("cities", {
    keyPrefix: "routes.aboutNvz",
  });
    ...
    <>
      ...
      <Promo img={promoImg}>
        ...
        <PromoContent desktopCenter spacing="xs">
          ...
          <PromoBreadcrumbs>
            <SelfCityLink />
            <BreadcrumbsLink href={`/nvz/hotel`} disabled>
              {t("title")}
            </BreadcrumbsLink>
          </PromoBreadcrumbs>
        </PromoContent>
